#include <stdio.h>
/*
Faça um programa que, para um número indeterminado de pessoas: leia a idade de cada pessoa,
sendo que a leitura da idade 0 (zero) indica o fim dos dados e não deve ser considerada; calcule e
mostre o número de pessoas; calcule e mostre a idade média do grupo; calcule e mostre a menor
...
int main (void){
    ...
    printf ("A quantidade de pessoas foi de %d\n", qtd);
