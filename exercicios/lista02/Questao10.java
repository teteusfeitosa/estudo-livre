...
/* 
* Faça um empréstimo que considere salário líquido,bruto e os descontos e atribua o empréstimo 30% do salário líquido
*/
public class Questao10 extends Questao {
    ...
    public void processar(){
        ...
        double desejoDeEmprestimo = scanner.nextDouble();
        
    
        if(desejoDeEmprestimo  > (0.3 *líquido) ){
